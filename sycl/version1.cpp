...
// ============================================================================
// SYCL IMPL 1: NATIVE FP64 ACCELERATION PIPELINE
// ============================================================================
...
// ============================================================================
// SYCL IMPL 2: CAMERA-RELATIVE ANCHOR PIPELINE (Optimized FP32 Throughput)
// ============================================================================
void runCameraRelativeFP32Pipeline(sycl::queue& q, const std::vector<LocalUtmInputFloat>& hostInputs, size_t numElements) {
    ...
    // Host computed Anchor constants mapping relative slopes via Central Differences
    ...
    q.submit([&](sycl::handler& cgh) {
        ...
        cgh.parallel_for<class RelativeAnchorFP32>(sycl::range<1>(numElements), [=](sycl::id<1> idx) {
            ...
            // Linear Jacobian matrix multiplication using raw FP32 components
            ...
            // Output values structured relative to the view matrix bounds
